...
const Cart = () => {
  ...
  return (
    ...
    <div className={styles.left}>
        ...
        <div className={styles.wrapper}>
          ...
          {open ? (
            <div className={styles.paymentMethods}>
              ...
              <PayPalScriptProvider
                options={{
                  "client-id": "ASMbpiYDos7c2l4c1ezh4L9X8t-FQmkHQuKKLYQV-pVDvz19V_48Ezt6mmvIbQyxlKYh861tGbQn48S9",
                  components: "buttons",
                  currency: "USD",
      ...
      {cash && <OrderDetails setState={isCash} total={cart.total} createOrder={createOrder} state={cash} />}
    </div>
  )
}
